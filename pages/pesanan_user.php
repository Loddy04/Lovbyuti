...
<!-- NAVBAR -->
    <div class="navdex">
        ...
        <div class="center-nav">
            ...
            <li class="nav-item"><a class="listnav" href="treatmen.php">Treatmen</a></li>
            <li class="nav-item"><a class="listnav" href="dashboard.php">Outlet</a></li>
        ...
        <div class="dropdown-content">
            ...
            <a href="treatmen.php">Treatments</a>
            <a href="dashboard.php">Outlet</a>
        ...
        <div class="card shadow m-auto p-auto">
            <div class="card-body judul">
                <div class="row">
                    <div class="col"></div>
                        <div class="col">
                            <pre style="color: floralwhite; font-size: 2rem;"><b>MY APPOINTMENT</b></pre>
                        </div>
                    <div class="col"></div>
                </div>
            </div>
